...
--
-- Host: 172.17.0.1    Database: web-bnsp
-- ------------------------------------------------------
...
CREATE TABLE `event` (
  ...
  `deskripsi` text,
  `tanggal_event` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `produk` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `produk_FK` (`id_kategori`),
  CONSTRAINT `produk_FK` FOREIGN KEY (`id_kategori`) REFERENCES `kategori_produk` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'web-bnsp'
--
...
-- Dump completed on 2023-06-23 12:47:48
