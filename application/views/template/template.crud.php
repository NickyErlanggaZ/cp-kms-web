            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link active" href="blank.html"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                        <li class="menu-header">Manajemen Konten</li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-home"></i> <span>Home</span></a></li>
                        <li><a class="nav-link" href="blank.html"><i class="fas fa-newspaper"></i> <span>Artikel</span></a></li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-calendar-alt"></i> <span>Event</span></a></li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-shopping-bag"></i> <span>Produk</span></a></li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-handshake"></i> <span>Klien</span></a></li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-images"></i> <span>Galeri Foto</span></a></li>
                        <li class="menu-header">Hak Akses</li>
                        <li><a class="nav-link" href="credits.html"><i class="fas fa-users"></i> <span>Pengguna</span></a></li>
                    </ul>
                </aside>
            </div>
